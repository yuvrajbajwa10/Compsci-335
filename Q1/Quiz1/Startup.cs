...
namespace Quiz1
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddMvc(options => options.OutputFormatters.Add(new VCalendarOutputFormatter()));
            services.AddMvc(options => options.OutputFormatters.Add(new VTimeTableOutputFormatter()));
